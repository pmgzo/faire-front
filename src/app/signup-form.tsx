            ...
            <div className="flex justify-center">
                <form onSubmit={onSubmit} className="flex flex-col space-y-4 w-full">
                    ...
                    <div className="flex flex-col">
                        <label className="ml-4 mb-1 font-['Inter'] text-sm text-[#888888]">Username<label className="text-[#FF0101]">*</label></label>
                        <input
                            className={`${
                                outlineInputs
                    ...
                    <div className="flex flex-col">
                    <label className="ml-4 mb-1 font-['Inter'] text-sm text-[#888888]">Confirm Password<label className="text-[#FF0101]">*</label></label>
                    <input
                        className={
                            outlineInputs
                                ? 'outline outline-2 outline-red-600 login-input placeholder-gray-700'
                    ...
                    <div className="text-bold text-black text-center bg-red-200"> CGU !</div>
