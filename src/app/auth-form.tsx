...
export const AuthForm: React.FunctionComponent<{}> = () => {
    ...
    return (<div className="grid justify-items-center w-full">
        <div className="border-3 border-[#D5D5D5] rounded-3xl w-2/4 py-8">
                <div className="flex flex-col">
                        <div className="flex justify-center">
                            <Image className="pb-10" width={100} src={Dadj} alt="follow us on twitter"/>
                        </div>
                    <div className="flex justify-center">
                        <div className="flex flex-col w-2/3">
                            ...
                            <div className="flex justify-center py-8">
                                ...
                                <div className="font-['InterBold'] text-[#BDBCBC] px-2">
                                    Or
                                </div>
                                <div className="flex flex-col justify-center">
                                    <div className="h-px w-48 bg-[#BDBCBC]"/>
